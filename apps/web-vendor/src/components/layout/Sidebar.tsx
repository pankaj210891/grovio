...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className={`border-t border-grovio-border px-3 py-2 ${sidebarCollapsed ? 'flex justify-center' : ''}`}>
        <button
          type="button"
          ...
          className="flex h-8 w-8 items-center justify-center rounded-md text-grovio-text-muted transition-colors hover:bg-grovio-surface hover:text-grovio-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-grovio-primary"
        >
          {isDark ? (
      ...
      {/* Onboarding checklist in sidebar footer (T9) */}
