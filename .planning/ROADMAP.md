...
- [x] 03-07-PLAN.md — vendor JWT middleware + vendor/admin/search routes + /categories/:id/filters; DI container + app.ts + main.ts worker startup
...
**Wave 3** *(blocked on Wave 2)*
- [x] 04-03-PLAN.md — CustomerAuthService (argon2/jose, reset flow) + mailer + requireCustomerAuth cookie middleware (TDD)
...
**Wave 6**
- [x] 05-09-PLAN.md — OrderService (vendor splitting + idempotent finalization) + CheckoutService (server-authoritative pricing + reservation)

**Wave 7**
- [x] 05-10-PLAN.md — Basket/checkout/webhook/account/vendor routes (raw-body webhooks) + Awilix container + app.ts + main.ts worker startup
...
| 11. UX/UI Platform Redesign | 3/6 | In Progress|  |
